...
thingName = "Thing3"                                    # Thing_Name
# Root_CA_Certificate_Name

caPath = "Certificates/AmazonRootCA1.pem"
# <Thing_Name>.cert.pem
certPath = "Certificates/Thing2 cred/33c6aeda67-certificate.pem.crt"
# <Thing_Name>.private.key
keyPath = "Certificates/Thing2 cred/33c6aeda67-private.pem.key"
...
while i <= 20:
    ...
    if connflag == True:
        ...
        mqttc.publish("Group8", payload_json, qos=1)
        # dyanmodb = boto3.resource("dynamodb", endpoint_url="")
        print("msg sent: Group8")  # Print sent temperature msg on console
        print(payload_json)
    else:
