...
clientId = "Group7Rpi_thing2_Shivani"                                     # Thing_Name
thingName = "Rpi"                                    # Thing_Name
caPath = "Assignment 7/Certificates/AmazonRootCA1.pem"                                      # Root_CA_Certificate_Name
certPath = "Assignment 7/Certificates/Thing1 cred/4d853f54cd-certificate.pem.crt"                            # <Thing_Name>.cert.pem
keyPath = "Assignment 7/Certificates/Thing1 cred/4d853f54cd-private.pem.key"                          # <Thing_Name>.private.key
